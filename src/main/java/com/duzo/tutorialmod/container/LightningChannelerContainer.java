...
public class LightningChannelerContainer extends Container {
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(),tileEntity.getPos()), playerIn, ModBlocks.LIGHTNING_CHANNELER.get());
    }
    ...
    // CREDIT GOES TO: diesieben07 | https://github.com/diesieben07/SevenCommons thank you :))))) - dozu the bozu
