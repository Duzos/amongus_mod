...
import com.duzo.tutorialmod.container.LightningChannelerContainer;
import com.duzo.tutorialmod.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity player) {
                return new LightningChannelerContainer(i,worldIn,pos,playerInventory,player);
            }
        };
    }
