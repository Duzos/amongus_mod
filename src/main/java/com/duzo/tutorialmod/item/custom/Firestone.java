package com.duzo.tutorialmod.item.custom;

import com.duzo.tutorialmod.TutorialMod;
import com.duzo.tutorialmod.util.TutorialTags;
...
public class Firestone extends Item {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        if(Screen.hasShiftDown()) {
            ...
            tooltip.add(new TranslationTextComponent("tooltip.tutorialmod.default"));
        }
